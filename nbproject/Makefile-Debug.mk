...
${OBJECTDIR}/_ext/85813d25/byte_msg_parser.o: /Users/drew/NetBeansProjects/dcr_server/byte_msg_parser.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/85813d25/byte_msg_parser.o /Users/drew/NetBeansProjects/dcr_server/byte_msg_parser.c

${OBJECTDIR}/_ext/85813d25/db_connection.o: /Users/drew/NetBeansProjects/dcr_server/db_connection.c
	${MKDIR} -p ${OBJECTDIR}/_ext/85813d25
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/85813d25/db_connection.o /Users/drew/NetBeansProjects/dcr_server/db_connection.c
...
${OBJECTDIR}/_ext/48f68b16/hashtable.o: /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/48f68b16/hashtable.o /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable.c

${OBJECTDIR}/_ext/48f68b16/hashtable_itr.o: /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable_itr.c
	${MKDIR} -p ${OBJECTDIR}/_ext/48f68b16
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/48f68b16/hashtable_itr.o /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable_itr.c

${OBJECTDIR}/_ext/48f68b16/hashtable_utility.o: /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable_utility.c
	${MKDIR} -p ${OBJECTDIR}/_ext/48f68b16
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/48f68b16/hashtable_utility.o /Users/drew/NetBeansProjects/dcr_server/hashtable/hashtable_utility.c

${OBJECTDIR}/distribution_container_manager.o: distribution_container_manager.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distribution_container_manager.o distribution_container_manager.c
