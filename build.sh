...
echo "building dbc.."
gcc -c -g -MMD -MP -MF "build/linux/db_connection.o.d" -o build/linux/db_connection.o db_connection.c
...
gcc -o dcr_server -lm build/linux/byte_msg_parser.o build/linux/db_connection.o build/linux/hashtable.o build/linux/hashtable_itr.o build/linux/hashtable_utility.o build/linux/distribution_container_manager.o build/linux/main.o -lpthread
